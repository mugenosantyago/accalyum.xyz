...
import DepositContractJson from "./Deposit.ral.json"
...
class Factory extends ContractFactory<DepositInstance, DepositTypes.Fields> {
  ...
  tests = {
    deposit: async (
      params: TestContractParamsWithoutMaps<DepositTypes.Fields, { from: Address; amount: bigint }>,
    ): Promise<TestContractResultWithoutMaps<null>> => {
      return testMethod(this, "deposit", params, getContractByCodeHash)
    },
    getTotalDeposits: async (
      params: Omit<TestContractParamsWithoutMaps<DepositTypes.Fields, never>, "testArgs">,
    ): Promise<TestContractResultWithoutMaps<bigint>> => {
      return testMethod(this, "getTotalDeposits", params, getContractByCodeHash)
    },
  }

  stateForTest(initFields: DepositTypes.Fields, asset?: Asset, address?: string) {
...
export const Deposit = new Factory(
  Contract.fromJson(DepositContractJson, "", "8c87926fb75f9bc456effdbff709ebe967b3fbef48038f514205c2821a4c841f", []),
)
...
export class DepositInstance extends ContractInstance {
  ...
  subscribeDepositMadeEvent(
    ...
    return subscribeContractEvent(Deposit.contract, this, options, "DepositMade", fromCount)
  }
  ...
  view = {
    deposit: async (
      ...
      return callMethod(Deposit, this, "deposit", params, getContractByCodeHash)
    },
    getTotalDeposits: async (
      params?: DepositTypes.CallMethodParams<"getTotalDeposits">,
    ): Promise<DepositTypes.CallMethodResult<"getTotalDeposits">> => {
      return callMethod(Deposit, this, "getTotalDeposits", params === undefined ? {} : params, getContractByCodeHash)
    },
  }
  ...
  async multicall<Callss extends DepositTypes.MultiCallParams | DepositTypes.MultiCallParams[]>(
    callss: Callss,
  ): Promise<unknown> {
