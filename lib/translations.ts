export const translations = {
  ...
  ja: {
    ...
    aboutVision:
      "私たちは、金融システムがすべての人にアクセス可能で、コミュニティが社会的課題に対処するために自己組織化でき、テクノロジーが世界の善の力として機能する未来を想像しています。",
    ...
    firstName: "名",
    lastName: "姓",
    first5DigitsOfAddress: "住所の最初の5桁",
    enterFirst5Digits: "住所の最初の5桁のみを入力してください",
    ...
    supportCommunity:
      "ALPHトークンでコミュニティイニシアチブと相互扶助プロジェクトをサポートします。すべての資金は仲介者なしで直接イニシアチブに送られます。",
    makeADonation: "寄付をする",
    supportInitiative: "ALPHトークンでイニシアチブをサポートします。",
