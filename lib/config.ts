...
export const config = {
  ...
  alephium: {
    ...
    yumFaucetAddress: process.env.NEXT_PUBLIC_YUM_FAUCET_ADDRESS || "vWvXtZRY7X5z1amCJ9U1rTzJ9SvbX6TUnchxhLgsbV3G",
    ...
    sweaFaucetAddress: process.env.NEXT_PUBLIC_SWEA_FAUCET_ADDRESS || "1DjCZbKGATt82mxygUDuNr8yYxf786SNc7ek9ZEeY3CYC",
