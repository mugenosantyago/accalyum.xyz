...
import { TokenFaucet, TokenFaucetInstance, Deposit, DepositInstance } from ".";
...
export type Deployments = {
  ...
  contracts: {
    ...
    Deposit: DeployContractExecutionResult<DepositInstance>;
  };
};
...
function toDeployments(json: any): Deployments {
  const contracts = {
    ...
    Deposit: {
      ...json.contracts["Deposit"],
      contractInstance: Deposit.at(
        json.contracts["Deposit"].contractInstance.address
      ),
    },
  };
  return {
