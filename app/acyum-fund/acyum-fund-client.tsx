...
export default function YumFundClient() {
  ...
  const handleYumDonate = async () => {
    ...
    try {
      // YUM has 4 decimals based on config.alephium.yumDecimals
      const yumDecimals = config.alephium.yumDecimals ?? 4; // Changed acyumDecimals to yumDecimals and default to 4
